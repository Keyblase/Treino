...
using Treino.Core.WebService;
using Treino.WebService.Models;

namespace Treino.WebService.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Index(Cep cep)
        {
            ...
            var correios = new TreinoCorreios.AtendeClienteClient();
